        ...
        while(true){
            try{
                ...
                if ("chasis".equals(parte)){
                    ...
                    MercadoAutomotriz.Nomina = MercadoAutomotriz.Nomina + salario*24*EmpleadosMaserati.eCarroceria; 
                    MercadoAutomotriz.diasCarroceria = MercadoAutomotriz.diasCarroceria + dias*EmpleadosMaserati.eCarroceria;
                    ...
                    MercadoAutomotriz.Nomina = MercadoAutomotriz.Nomina + salario*24*EmpleadosMaserati.eMotor; 
                    MercadoAutomotriz.diasMotor = MercadoAutomotriz.diasMotor + dias*EmpleadosMaserati.eMotor;
                    ...
                    MercadoAutomotriz.Nomina = MercadoAutomotriz.Nomina + salario*24*EmpleadosMaserati.eRuedas; 
                    MercadoAutomotriz.diasRueda = MercadoAutomotriz.diasMotor + dias*EmpleadosMaserati.eRuedas;
                    ...
                    MercadoAutomotriz.Nomina = MercadoAutomotriz.Nomina + salario*24*EmpleadosMaserati.eAccesorios; 
                    MercadoAutomotriz.diasAccesorio = MercadoAutomotriz.diasAccesorio + dias*EmpleadosMaserati.eAccesorios;
